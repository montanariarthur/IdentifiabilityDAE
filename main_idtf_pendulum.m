...
figure(1);
subplot(221); plot(t,x(:,[1 2]),t,constraint1); legend('x','y');
subplot(222); plot(t,x(:,[3 4]),t,constraint2); legend('u','v');
subplot(223); plot(t,x(:,5),t,constraint3);     legend('\lambda');
subplot(224); plot(t,angle);                    legend('y = \phi');
